...
char* g_szApplicationName = "Predator-Prey Game";
...
UINT timerStep = 100;//ms
void CALLBACK SimulationProc(HWND hwnd, UINT message, UINT iTImerID, DWORD dwTimer)
{
	float epliseTime = timerStep/1000.0;
	//g_GameWorld->Update(epliseTime);
                    ...
                    int       iCmdShow)
{
  ...
  //creat my timer
  SetTimer(hWnd,1,timerStep, SimulationProc);
