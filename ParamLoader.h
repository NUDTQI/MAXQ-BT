...
private:
  ...
  {
	StartMap                = GetNextTokenAsString();

    NumPredatorAgents       = GetNextParameterInt();

	NumPreyAgents           = GetNextParameterInt();
    ...
    AgentMass             = GetNextParameterFloat();
    AgentScale            = GetNextParameterFloat();
	MaxAgentHealth        = GetNextParameterInt();
	...
	gamma                   = GetNextParameterFloat();
	beta                    = GetNextParameterFloat();
	exploration             = GetNextParameterFloat();

	DamagePreyToPredator    = GetNextParameterInt();
	DamagePredatorToPrey    = GetNextParameterInt();
	HealthGainInFoodZ       = GetNextParameterInt();
	TimeOutGame             = GetNextParameterInt();
	MaxRunTimes             = GetNextParameterInt();
...
public:
  ...
  //settings of judger
  int     DamagePreyToPredator;
  int	  DamagePredatorToPrey;
  int	  HealthGainInFoodZ;
  int	  TimeOutGame;
  int	  MaxRunTimes;
};
