...
public:
  ...
  std::string QTableFileRetreat;
  std::string QTableFileAttack;
  std::string QTableFileIdle;

	QLearning* m_pRootQLearner;
		QLearning* m_pRetreatQLearner;
			QLearning* m_pFleeQLearner;
			QLearning* m_pSeekSafetyQLearner;
		QLearning* m_pIdleQLearner;
			QLearning* m_pGrazeQLearner;
				QLearning* m_pForageQLearner;
				QLearning* m_pEatQLearner;
			QLearning* m_pExploreQLearner;
				QLearning* m_pFlockQLearner;
				QLearning* m_pWanderQLearner;
		QLearning* m_pAttackQLearner;
			QLearning* m_pChargeQLearner;
				QLearning* m_pAssistQLearner;
		//QLearning* m_pRandomWalk;
