...
public:
	...
	virtual void BindModelForLearner();
	//define EnvModel for bev node needing learning
	
	//ModelSelRootBevLearning* pRootEnvModel;
	//ModelSelRetreatBevLearning* pRetreatEnvModel;
	//ModelSelAttackBevLearning* pAttackEnvModel;
	ModelSelGeneralBevLearning* pRootEnvModel;
	ModelSelGeneralBevLearning* pRetreatEnvModel;
	ModelSelGeneralBevLearning* pFleeEnvModel;
	ModelSelGeneralBevLearning* pSeekSafetyEnvModel;
	ModelSelGeneralBevLearning* pIdleEnvModel;
	ModelSelGeneralBevLearning* pGrazeEnvModel;
    ModelSelGeneralBevLearning* pForageEnvModel;
	ModelSelGeneralBevLearning* pEatEnvModel;
	ModelSelGeneralBevLearning* pExploreEnvModel;
	ModelSelGeneralBevLearning* pFlockEnvModel;
	ModelSelGeneralBevLearning* pWanderEnvModel;
	ModelSelGeneralBevLearning* pAttackEnvModel;
	ModelSelGeneralBevLearning* pChargeEnvModel;
	ModelSelGeneralBevLearning* pAssistEnvModel;

	std::map<BevNode*,QLearning*> NodeQMap;
	std::map<BevNode*,EnvModelLearning*> NodeEnvMap;

	GeneralEvaluator* pEvaluator;
